...
class Formulario extends Component {
  ...
  enviar = async e => {
    ...
    const response = await this.client.createProducto(this.state.producto);
  ...
  render() {
    ...
    return (
      <>
        <div className='row'>
          <h2 className='col s12 m8 offset-m2'>Agrega un producto</h2>
        </div>
        <div className='row'>
          <form className='col s12 m8 offset-m2 ' onSubmit={this.enviar}>
            <div className='row'>
